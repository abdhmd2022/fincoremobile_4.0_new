...
class ItemsTotalClickedCostCenterLedger extends StatefulWidget {
  ...
  @override
  _ItemsTotalClickedCostCenterLedgerPageState createState() =>
...
class _ItemsTotalClickedCostCenterLedgerPageState
    extends State<ItemsTotalClickedCostCenterLedger>
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      ItemsTotalClickedCostCenterLedgerVchType(
