...
class ItemsTotalClickedCostCenterLedgerVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,item_name,total,ledgername,vchname,costcenter;

  const ItemsTotalClickedCostCenterLedgerVchType(
  ...
  @override
  _ItemsTotalClickedCostCenterLedgerVchTypePageState createState() => _ItemsTotalClickedCostCenterLedgerVchTypePageState(startDateString: startdate_string,
...
class _ItemsTotalClickedCostCenterLedgerVchTypePageState extends State<ItemsTotalClickedCostCenterLedgerVchType> with TickerProviderStateMixin{
  ...
  _ItemsTotalClickedCostCenterLedgerVchTypePageState(
