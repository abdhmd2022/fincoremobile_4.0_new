...
import 'ItemsTotalClickedCostCenterVchTypeLedger.dart';
import 'Sidebar.dart';
...
class ItemsTotalClickedCostCenterVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,item_name,total,vchname,costcenter;

  const ItemsTotalClickedCostCenterVchType(
  ...
  @override
  _ItemsTotalClickedCostCenterVchTypePageState createState() => _ItemsTotalClickedCostCenterVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,item_name:  item_name,vchname: vchname,costcenter: costcenter);
}

class _ItemsTotalClickedCostCenterVchTypePageState extends State<ItemsTotalClickedCostCenterVchType> with TickerProviderStateMixin{
  ...
  _ItemsTotalClickedCostCenterVchTypePageState(
  ...
  Future<void> generateAndSharePDF_Ledger() async {
    ...
    const headers = ['Party Name', 'Qty', 'Amount'];
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ItemsTotalClickedCostCenterVchTypeLedger(
