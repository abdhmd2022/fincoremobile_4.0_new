...
class ItemsTotalClickedLedger extends StatefulWidget {
  ...
  @override
  _ItemsTotalClickedLedgerPageState createState() =>
...
class _ItemsTotalClickedLedgerPageState extends State<ItemsTotalClickedLedger>
  ...
  List<String> spinner_list = ['Bills', 'Voucher Type', 'Cost Center'];
  ...
  Future<void> generateAndShareCSV_VchType() async {
    ...
    final csvData = [
      ...
      ...vouchertype_list.map(
        (item) => [item.vchname, item.qty, formatAmount(item.amount)],
      ),
    ];
