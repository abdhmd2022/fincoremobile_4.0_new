...
import 'ItemsTotalClickedLedgerCostCenter.dart';
import 'Sidebar.dart';
...
class ItemsTotalClickedLedger extends StatefulWidget
{
  final String startdate_string,enddate_string,type,item_name,total,ledgername;

  const ItemsTotalClickedLedger(
  ...
  @override
  _ItemsTotalClickedLedgerPageState createState() => _ItemsTotalClickedLedgerPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,item_name:  item_name,ledger_name: ledgername);
}

class _ItemsTotalClickedLedgerPageState extends State<ItemsTotalClickedLedger> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",item_name = "",total = "",ledger_name = "";
  ...
  _ItemsTotalClickedLedgerPageState(
  ...
  List<String> spinner_list = [
    'Bills', 'Voucher Type','Cost Center'
  ];
  ...
  Future<void> generateAndSharePDF_VchType() async {
    ...
    const headers = ['Vch Name', 'Qty', 'Amount'];
    const itemsPerPage = 7;
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    const headers = ['Cost Center', 'Qty', 'Amount'];
    const itemsPerPage = 7;
  ...
  Future<void> fetchBills(final String item,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String ledgername) async
  {
  ...
  Future<void> fetchVoucherType(final String item,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String ledgername) async
  {
  ...
  Future<void> fetchCostCenter(final String item,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String ledgername) async
  {
  ...
  Future<void> _initSharedPreferences() async {
    ...
    {
      fetchBills(item_name,startDateString,endDateString,type,"vchno","vchno",ledger_name);

    }
    else if (_selectedgroup == "Voucher Type")
    {
      fetchVoucherType(item_name,startDateString,endDateString,type,"vchname","vchname",ledger_name);

    }
    else if (_selectedgroup == "Cost Center")
    {
      fetchCostCenter(item_name,startDateString,endDateString,type,"costcentre","costcentre",ledger_name);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ItemsTotalClickedLedgerVchType(
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ItemsTotalClickedLedgerCostCenter(
                    startdate_string: startDateString,
                    enddate_string: endDateString,
                    type: type,
                    total: formatAmount(item.amount),
