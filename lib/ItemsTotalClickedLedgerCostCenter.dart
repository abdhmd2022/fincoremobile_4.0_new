...
class ItemsTotalClickedLedgerCostCenter extends StatefulWidget {
  final String startdate_string,
      ...
      ledgername,
      costcenter;
  const ItemsTotalClickedLedgerCostCenter({
  ...
  @override
  _ItemsTotalClickedLedgerCostCenterPageState createState() =>
      _ItemsTotalClickedLedgerCostCenterPageState(
...
class _ItemsTotalClickedLedgerCostCenterPageState
    extends State<ItemsTotalClickedLedgerCostCenter>
  ...
  List<String> spinner_list = ['Bills', 'Voucher Type'];
        ...
        pw.Page(
          build: (_) => pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 10),
              pw.Text(
                'Cost Center: ${formatCostCenter(costCenter)}',
                style: pw.TextStyle(
                  fontSize: 16,
                  fontWeight: pw.FontWeight.bold,
                ),
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      ItemsTotalClickedLedgerCostCenterVchType(
