...
class ItemsTotalClickedLedgerCostCenter extends StatefulWidget
{
  ...
  @override
  _ItemsTotalClickedLedgerCostCenterPageState createState() => _ItemsTotalClickedLedgerCostCenterPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,item_name:  item_name,ledger_name: ledgername,costcenter: costcenter);
}

class _ItemsTotalClickedLedgerCostCenterPageState extends State<ItemsTotalClickedLedgerCostCenter> with TickerProviderStateMixin{
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ItemsTotalClickedLedgerCostCenterVchType(
