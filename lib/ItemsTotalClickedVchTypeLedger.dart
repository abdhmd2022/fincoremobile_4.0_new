...
import 'ItemsTotalClickedVchTypeLedgerCostCenter.dart';
import 'Sidebar.dart';
...
class ItemsTotalClickedVchTypeLedger extends StatefulWidget
{
  final String startdate_string,enddate_string,type,item_name,total,ledgername,vchname;

   ItemsTotalClickedVchTypeLedger(
  ...
  @override
  _ItemsTotalClickedVchTypeLedgerPageState createState() => _ItemsTotalClickedVchTypeLedgerPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,item_name:  item_name,ledger_name: ledgername,vchname: vchname);
}

class _ItemsTotalClickedVchTypeLedgerPageState extends State<ItemsTotalClickedVchTypeLedger> with TickerProviderStateMixin{
  ...
  _ItemsTotalClickedVchTypeLedgerPageState(
  ...
  Future<void> generateAndSharePDF_Bills() async {
    ...
    const headersRow3 = ['Vch Date', 'Vch No', 'Party Name', 'Amount'];
        ...
        pw.Page(
          build: (context) => pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 10),
              pw.Text('Stock Item: $itemname', style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 10),
              pw.Text('Voucher Type: $vch_name', style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 10),
              pw.Text('Ledger: $ledgername', style: pw.TextStyle(fontSize: 16)),
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    const headersRow3 = ['Cost Center', 'Qty', 'Amount'];
    const itemsPerPage = 6;
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child:  Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                               Icon(Icons.account_tree_rounded, size: 18, color: Colors.black54),
                               SizedBox(width: 6),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                ...
                return _buildCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ItemsTotalClickedVchTypeLedgerCostCenter(
