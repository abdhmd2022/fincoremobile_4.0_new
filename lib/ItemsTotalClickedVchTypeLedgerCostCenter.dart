...
class ItemsTotalClickedVchTypeLedgerCostCenter extends StatefulWidget
{
  final String startdate_string,enddate_string,type,item_name,total,ledgername,vchname,costcenter;

   ItemsTotalClickedVchTypeLedgerCostCenter(
  ...
  @override
  _ItemsTotalClickedVchTypeLedgerCostCenterPageState createState() => _ItemsTotalClickedVchTypeLedgerCostCenterPageState(startDateString: startdate_string,
...
class _ItemsTotalClickedVchTypeLedgerCostCenterPageState extends State<ItemsTotalClickedVchTypeLedgerCostCenter> with TickerProviderStateMixin{
  ...
  _ItemsTotalClickedVchTypeLedgerCostCenterPageState(
  ...
  String? SecuritybtnAcessHolder,costcentername = "",token = '';
          ...
          build: (context) => pw.Container(
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 10),
                pw.Text('Stock Item: $itemname', style: const pw.TextStyle(fontSize: 16)),
                pw.SizedBox(height: 10),
                pw.Text('Voucher Type: $vch_name', style: const pw.TextStyle(fontSize: 16)),
                pw.SizedBox(height: 10),
                pw.Text('Ledger: $ledgername', style: const pw.TextStyle(fontSize: 16)),
                pw.SizedBox(height: 10),
