...
class PartyTotalClicked extends StatefulWidget {
  ...
  @override
  _PartyTotalClickedPageState createState() => _PartyTotalClickedPageState(
...
class _PartyTotalClickedPageState extends State<PartyTotalClicked>
  ...
  List<String> spinner_list = ['Items', 'Bills', 'Voucher Type', 'Cost Center'];
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      final startIndex = pageNumber * itemsPerPage;
      final endIndex = (pageNumber + 1) * itemsPerPage > costcenter_list.length
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildListSection(
                          context,
                        ), // Refactored list rendering below
                      ),
                    ],
                  ),
                ),
