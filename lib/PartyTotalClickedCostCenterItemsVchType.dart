...
class PartyTotalClickedCostCenterItemsVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item,vchname,costcenter;

  const PartyTotalClickedCostCenterItemsVchType(
  ...
  @override
  _PartyTotalClickedCostCenterItemsVchTypePageState createState() => _PartyTotalClickedCostCenterItemsVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item,vchname: vchname,costcenter:costcenter);
}

class _PartyTotalClickedCostCenterItemsVchTypePageState extends State<PartyTotalClickedCostCenterItemsVchType> with TickerProviderStateMixin{
  ...
  _PartyTotalClickedCostCenterItemsVchTypePageState(
