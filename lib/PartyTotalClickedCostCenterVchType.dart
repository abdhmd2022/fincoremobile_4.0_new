...
import 'PartyTotalClickedCostCenterVchTypeItems.dart';
import 'Sidebar.dart';
...
class PartyTotalClickedCostCenterVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,costcenter,vchname;

  const PartyTotalClickedCostCenterVchType(
  ...
  @override
  _PartyTotalClickedCostCenterVchTypePageState createState() => _PartyTotalClickedCostCenterVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,costcenter:costcenter,vchname:vchname);
}

class _PartyTotalClickedCostCenterVchTypePageState extends State<PartyTotalClickedCostCenterVchType> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",ledger = "",total = "",costcenter = "",vchname ="";
  ...
  _PartyTotalClickedCostCenterVchTypePageState(
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Text('Voucher Type:',
                        style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
                    pw.SizedBox(width: 5),
                    pw.Text(vchname, style: pw.TextStyle(fontSize: 16)),
                  ],
                ),
  ...
  Future<void> generateAndSharePDF_Bills() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      ...
      final tableSubsetRows = itemsSubset
          .map((item) =>
      [convertDateFormat(item.vchdate), item.vchno, formatAmount(item.amount)])
          .toList();
  ...
  Future<void> generateAndShareCSV_Bills() async {
    ...
    final List<List<dynamic>> csvData = [];
    csvData.add(['Vch Date', 'Vch No', 'Amount']);
  ...
  Future<void> fetchBills(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String costcenter,final String vchname) async
  {
  ...
  Future<void> fetchItems(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String costcenter,final String vchname) async
  {
  ...
  Future<void> _initSharedPreferences() async {
    ...
    {
      fetchItems(ledger,startDateString,endDateString,type,"Item","Item",costcenter,vchname);

    }
    else if (_selectedgroup == "Bills")
    {
      fetchBills(ledger,startDateString,endDateString,type,"vchno","vchno",costcenter,vchname);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedCostCenterVchTypeItems(
