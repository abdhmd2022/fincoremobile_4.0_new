import 'dart:convert';
import 'package:fincoremobile/PartyTotalClickedItemsVchType.dart';
import 'package:fincoremobile/currencyFormat.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'PartyTotalClickedItemsCostCenter.dart';
import 'Sidebar.dart';
...
class PartyTotalClickedItems extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item;

  const PartyTotalClickedItems(
  ...
  @override
  _PartyTotalClickedItemsPageState createState() => _PartyTotalClickedItemsPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item);
}

class _PartyTotalClickedItemsPageState extends State<PartyTotalClickedItems> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",ledger = "",total = "",item="";
  ...
  _PartyTotalClickedItemsPageState(
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      ...
      final tableSubsetRows = itemsSubset
          .map((item) => [formatCostCenter(item.costcentre), formatAmount(item.amount)])
          .toList();
  ...
  Future<void> fetchBills(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String item) async
  {
  ...
  Future<void> fetchVoucherType(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String item) async
  {
    setState(() {
      _isLoading = true;
  ...
  Future<void> fetchCostCenter(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String item) async
  {
  ...
  Future<void> _initSharedPreferences() async {
   ...
   if (_selectedgroup == "Bills")
    {
      fetchBills(ledger,startDateString,endDateString,type,"vchno","vchno",item);

    }
    else if (_selectedgroup == "Voucher Type")
    {
      fetchVoucherType(ledger,startDateString,endDateString,type,"vchname","vchname",item);

    }
    else if (_selectedgroup == "Cost Center")
    {
      fetchCostCenter(ledger,startDateString,endDateString,type,"costcentre","costcentre",item);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedItemsVchType(
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedItemsCostCenter(
                    startdate_string: startDateString,
                    enddate_string: endDateString,
                    type: type,
                    total: formatAmount(card.amount),
