...
class PartyTotalClickedItemsCostCenterVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item,vchname,costcenter;

  const PartyTotalClickedItemsCostCenterVchType(
  ...
  @override
  _PartyTotalClickedItemsCostCenterVchTypePageState createState() => _PartyTotalClickedItemsCostCenterVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item,vchname: vchname,costcenter:costcenter);
}

class _PartyTotalClickedItemsCostCenterVchTypePageState extends State<PartyTotalClickedItemsCostCenterVchType> with TickerProviderStateMixin{
  ...
  _PartyTotalClickedItemsCostCenterVchTypePageState(
