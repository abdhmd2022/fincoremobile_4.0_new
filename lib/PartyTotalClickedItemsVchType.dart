...
import 'PartyTotalClickedItemsVchTypeCostCenter.dart';
import 'Sidebar.dart';
...
class PartyTotalClickedItemsVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item,vchname;

  const PartyTotalClickedItemsVchType(
  ...
  @override
  _PartyTotalClickedItemsVchTypePageState createState() => _PartyTotalClickedItemsVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item,vchname: vchname);
}

class _PartyTotalClickedItemsVchTypePageState extends State<PartyTotalClickedItemsVchType> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",ledger = "",total = "",item="",vchname="";
  ...
  _PartyTotalClickedItemsVchTypePageState(
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      ...
      final itemsSubset = costcenter_list.sublist(
          startIndex, endIndex > costcenter_list.length ? costcenter_list.length : endIndex);
  ...
  Future<void> fetchBills(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String item,final String vchname) async
  {
  ...
  Future<void> fetchCostCenter(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String item,final String vchname) async
  {
  ...
  Future<void> _initSharedPreferences() async {
    ...
    {
      fetchBills(ledger,startDateString,endDateString,type,"vchno","vchno",item,vchname);

    }

    else if (_selectedgroup == "Cost Center")
    {
      fetchCostCenter(ledger,startDateString,endDateString,type,"costcentre","costcentre",item,vchname);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedItemsVchTypeCostCenter(
