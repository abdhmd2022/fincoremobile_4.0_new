import 'dart:convert';
import 'package:fincoremobile/PartyTotalClickedVchTypeItems.dart';
import 'package:fincoremobile/currencyFormat.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'PartyTotalClickedVchTypeCostCenter.dart';
import 'Sidebar.dart';
...
class PartyTotalClickedVchType extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,vchname;

  const PartyTotalClickedVchType(
  ...
  @override
  _PartyTotalClickedVchTypePageState createState() => _PartyTotalClickedVchTypePageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,vchname: vchname);
}

class _PartyTotalClickedVchTypePageState extends State<PartyTotalClickedVchType> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",ledger = "",total = "",vchname = "";
  ...
  _PartyTotalClickedVchTypePageState(
  ...
  Future<void> generateAndSharePDF_CostCenter() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      final startIndex = pageNumber * itemsPerPage;
      final endIndex = (pageNumber + 1) * itemsPerPage;
      final itemsSubset = costcenter_list.sublist(startIndex, endIndex > costcenter_list.length ? costcenter_list.length : endIndex);
  ...
  Future<void> generateAndShareCSV_CostCenter() async {
    ...
    final List<List<dynamic>> csvData = [];
    final headersRow = ['Cost Center', 'Amount'];
    csvData.add(headersRow);
  ...
  Future<void> fetchBills(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String vchname) async
  {
  ...
  Future<void> fetchItems(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String vchname) async
  {
  ...
  Future<void> fetchCostCenter(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String vchname) async
  {
  ...
  Future<void> _initSharedPreferences() async {
    ...
    {
      fetchItems(ledger,startDateString,endDateString,type,"Item","Item",vchname);

    }
    else if (_selectedgroup == "Bills")
    {
      fetchBills(ledger,startDateString,endDateString,type,"vchno","vchno",vchname);

    }

    else if (_selectedgroup == "Cost Center")
    {
      fetchCostCenter(ledger,startDateString,endDateString,type,"costcentre","costcentre",vchname);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedVchTypeItems(
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedVchTypeCostCenter(
                    startdate_string: startDateString,
                    enddate_string: endDateString,
                    type: type,
                    total: formatAmount(card.amount),
