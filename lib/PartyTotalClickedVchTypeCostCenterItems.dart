...
class PartyTotalClickedVchTypeCostCenterItems extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item,vchname,costcenter;

  const PartyTotalClickedVchTypeCostCenterItems(
  ...
  @override
  _PartyTotalClickedVchTypeCostCenterItemsPageState createState() => _PartyTotalClickedVchTypeCostCenterItemsPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item,vchname: vchname,costcenter:costcenter);
}

class _PartyTotalClickedVchTypeCostCenterItemsPageState extends State<PartyTotalClickedVchTypeCostCenterItems> with TickerProviderStateMixin{
  ...
  _PartyTotalClickedVchTypeCostCenterItemsPageState(
