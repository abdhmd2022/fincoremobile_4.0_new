...
import 'PartyTotalClickedVchTypeItemsCostCenter.dart';
import 'Sidebar.dart';
...
class PartyTotalClickedVchTypeItems extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,vchname,item;

  const PartyTotalClickedVchTypeItems (
  ...
  @override
  _PartyTotalClickedVchTypeItemsPageState createState() => _PartyTotalClickedVchTypeItemsPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,vchname: vchname,item:item);
}

class _PartyTotalClickedVchTypeItemsPageState extends State<PartyTotalClickedVchTypeItems> with TickerProviderStateMixin{
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  String startDateString = "",endDateString = "",type = "",ledger = "",total = "",vchname = "",item="";
  ...
  _PartyTotalClickedVchTypeItemsPageState(
  ...
  Future<void> generateAndSharePDF_Bills() async {
    ...
    for (int pageNumber = 0; pageNumber < pageCount; pageNumber++) {
      ...
      final tableSubset = pw.Table.fromTextArray(
        ...
        columnWidths: {
          0: pw.FractionColumnWidth(0.33),
          1: pw.FractionColumnWidth(0.33),
          2: pw.FractionColumnWidth(0.33),
        },
            ...
            return pw.Column(
              ...
              children: [
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.center,
                  children: [
                    pw.Text('Stock Item:', style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)),
                    pw.SizedBox(width: 5),
  ...
  Future<void> fetchBills(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String vchname,final String item) async
  {
  ...
  Future<void> fetchCostCenter(final String ledger,final String startdate, final String enddate, final String vchtype, final String groupby,final String orderby,final String vchname,final String item) async
  {
  ...
  Future<void> _initSharedPreferences() async {
    ...
    {
      fetchBills(ledger,startDateString,endDateString,type,"vchno","vchno",vchname,item);

    }

    else if (_selectedgroup == "Cost Center")
    {
      fetchCostCenter(ledger,startDateString,endDateString,type,"costcentre","costcentre",vchname,item);
          ...
          return _buildCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PartyTotalClickedVchTypeItemsCostCenter(
