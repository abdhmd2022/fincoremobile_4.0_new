...
class PartyTotalClickedVchTypeItemsCostCenter extends StatefulWidget
{
  final String startdate_string,enddate_string,type,ledger,total,item,vchname,costcenter;

  const PartyTotalClickedVchTypeItemsCostCenter(
      {
  ...
  @override
  _PartyTotalClickedVchTypeItemsCostCenterPageState createState() => _PartyTotalClickedVchTypeItemsCostCenterPageState(startDateString: startdate_string,
      endDateString: enddate_string,type: type,total: total,ledger:  ledger,item:item,vchname: vchname,costcenter:costcenter);
}

class _PartyTotalClickedVchTypeItemsCostCenterPageState extends State<PartyTotalClickedVchTypeItemsCostCenter> with TickerProviderStateMixin{
  ...
  _PartyTotalClickedVchTypeItemsCostCenterPageState(
